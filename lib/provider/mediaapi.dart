...
class MediaApi extends BaseApi {
  ...
  // Future<TblPhoto?> uploadPhoto(TblPhoto? photo) async {
  ...
  //   var uri = BaseApi.getSelectedUri(Constants.uriUploadFoto);
  //   log('Trying to upload ${photo.photoId} $fileNameWOPath -> $uri');
  //   var res = await dio.postUri(
  //     uri,
  //     options: dio_lib.Options(method: 'POST', responseType: dio_lib.ResponseType.json),
  //     data: formData,
  ...
  // Future<bool> uploadPhotos(List<TblPhoto> list) async {
  ...
  //       return false;
  //     } catch (e) {
  //       if (e is dio_lib.DioError && e.response?.statusCode == 403) rethrow;
  //       return false;
  //     }
  //   }).toList());
